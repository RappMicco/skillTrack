    ...
    <>
      ...
      <div className="overflow-x-auto">
        ...
        <table className="w-full text-sm">
          ...
          {/* ================================================================================= TABLE DETAILS =========================================================================================*/}
          <tbody>
            <tr className="border-b border-white/4 hover:bg:white/3 transition-colors group">
              <td className="px-5 py-4">
                {/* initials and fullname container*/}
                <div className="flex items-center gap-2.5">
                  {/* initials */}
                  <div className="w-7 h-7 rounded-full flex items-center justify-center text-[12px] font-bold text-white shrink-0 border border-cyan-500 bg-linear-to-br from-blue-500 to-cyan-400">
                    R
                  </div>
